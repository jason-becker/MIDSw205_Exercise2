...
cp MIDSw205_Exercise2/scripts/tweetcount.py tweetwordcount/src/bolts/tweetcount.py
...
cp MIDSw205_Exercise2/scripts/start-tweetcount.py start-tweetcount.py
